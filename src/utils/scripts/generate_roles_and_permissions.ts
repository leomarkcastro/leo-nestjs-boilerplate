...
export async function generate_roles_and_permissions() {
  ...
  const PERMISSIONS_TO_ROLE = {
    [Roles.USER]: [
      ...
      PERMISSIONS.EVENTS.CALENDAR.CREATE,
      PERMISSIONS.EVENTS.CALENDAR.DELETE,
      PERMISSIONS.EVENTS.CALENDAR.UPDATE,
      PERMISSIONS.EVENTS.CALENDAR.MODIFY_MEMBERS,
      PERMISSIONS.EVENTS.CALENDAR.ADD_MEMBERS,
      PERMISSIONS.EVENTS.CALENDAR.DELETE_MEMBERS,
      PERMISSIONS.EVENTS.EVENT.GET,
      PERMISSIONS.EVENTS.STATUSBOARD.GET,
